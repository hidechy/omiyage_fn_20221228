...
abstract class $PregnantHealthCheckSelectStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({CheckupListModel checkupList, bool loading});
...
class _$_PregnantHealthCheckSelectState
  ...
  @override
  String toString() {
    return 'PregnantHealthCheckSelectState(checkupList: $checkupList, loading: $loading)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, checkupList, loading);
...
abstract class _PregnantHealthCheckSelectState
  ...
  const factory _PregnantHealthCheckSelectState(
      {final CheckupListModel checkupList,
      final bool loading}) = _$_PregnantHealthCheckSelectState;
