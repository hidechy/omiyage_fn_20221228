...
mixin _$BabyInputState {
  BabyInputData get inputData => throw _privateConstructorUsedError;
...
abstract class $BabyInputStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({BabyInputData inputData, bool saving});
...
class _$_BabyInputState implements _BabyInputState {
  const _$_BabyInputState(
      {this.inputData = const BabyInputData(), this.saving = false});
  ...
  @override
  String toString() {
    return 'BabyInputState(inputData: $inputData, saving: $saving)';
  }
...
abstract class _BabyInputState implements BabyInputState {
  const factory _BabyInputState(
      {final BabyInputData inputData, final bool saving}) = _$_BabyInputState;
