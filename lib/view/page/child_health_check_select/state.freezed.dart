...
// 乳幼児健診マスタ（健診一覧、入力画面のタイトルで使う）
  ...
  bool get showHealthCheckList => throw _privateConstructorUsedError; // ローディング
...
// ローディング
  ...
  @override
  String toString() {
    return 'ChildHealthCheckSelectState(childCheckupTypes: $childCheckupTypes, checkupHistory: $checkupHistory, inputData: $inputData, showHealthCheckList: $showHealthCheckList, loading: $loading)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, childCheckupTypes,
      checkupHistory, inputData, showHealthCheckList, loading);
...
abstract class _ChildHealthCheckSelectState
  ...
  const factory _ChildHealthCheckSelectState(
      ...
      final ChildHealthCheckInputData inputData,
      final bool showHealthCheckList,
      final bool loading}) = _$_ChildHealthCheckSelectState;
