...
abstract class $ChildEditStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({ChildEditData inputData, bool saving});
...
class _$_ChildEditState implements _ChildEditState {
  const _$_ChildEditState(
      {this.inputData = const ChildEditData(), this.saving = false});
  ...
  @override
  String toString() {
    return 'ChildEditState(inputData: $inputData, saving: $saving)';
  }
...
abstract class _ChildEditState implements ChildEditState {
  const factory _ChildEditState(
      {final ChildEditData inputData, final bool saving}) = _$_ChildEditState;
