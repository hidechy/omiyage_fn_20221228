...
// 選択中の対象期間
  ...
  @override
  String toString() {
    return 'ChildWeightGraphState(growthGraphDataList: $growthGraphDataList, bandGraphDataList: $bandGraphDataList, selectedGraphType: $selectedGraphType, selectedChildGrapthPreriod: $selectedChildGrapthPreriod, showPeriodPulldown: $showPeriodPulldown, loading: $loading)';
  }
...
abstract class _ChildWeightGraphState implements ChildWeightGraphState {
  const factory _ChildWeightGraphState(
      ...
      final ChildGrapthPreriod selectedChildGrapthPreriod,
      final bool showPeriodPulldown,
      final bool loading}) = _$_ChildWeightGraphState;
