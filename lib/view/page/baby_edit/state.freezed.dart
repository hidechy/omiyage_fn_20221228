...
mixin _$BabyEditState {
  BabyEditData get inputData => throw _privateConstructorUsedError;
...
abstract class $BabyEditStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({BabyEditData inputData, bool saving});
...
class _$_BabyEditState implements _BabyEditState {
  const _$_BabyEditState(
      {this.inputData = const BabyEditData(), this.saving = false});
  ...
  @override
  String toString() {
    return 'BabyEditState(inputData: $inputData, saving: $saving)';
  }
...
abstract class _BabyEditState implements BabyEditState {
  const factory _BabyEditState(
      {final BabyEditData inputData, final bool saving}) = _$_BabyEditState;
