...
abstract class $PregnantWeightRecordSelectStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({PregnantWeightRecordListModel recordList, bool loading});
...
class _$_PregnantWeightRecordSelectState
  ...
  @override
  String toString() {
    return 'PregnantWeightRecordSelectState(recordList: $recordList, loading: $loading)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, recordList, loading);
...
abstract class _PregnantWeightRecordSelectState
  ...
  const factory _PregnantWeightRecordSelectState(
      {final PregnantWeightRecordListModel recordList,
      final bool loading}) = _$_PregnantWeightRecordSelectState;
