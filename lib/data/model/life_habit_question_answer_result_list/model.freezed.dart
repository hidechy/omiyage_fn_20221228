...
mixin _$LifeHabitQuestionAnswerResultListModel {
  ...
  GeneralCommentModel get generalComment => throw _privateConstructorUsedError;
...
abstract class $LifeHabitQuestionAnswerResultListModelCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'general_comments') GeneralCommentModel generalComment});

  $GeneralCommentModelCopyWith<$Res> get generalComment;
}
...
class _$LifeHabitQuestionAnswerResultListModelCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      generalComment: null == generalComment
          ? _value.generalComment
          : generalComment // ignore: cast_nullable_to_non_nullable
              as GeneralCommentModel,
    ) as $Val);
  }
  ...
  @pragma('vm:prefer-inline')
  $GeneralCommentModelCopyWith<$Res> get generalComment {
    return $GeneralCommentModelCopyWith<$Res>(_value.generalComment, (value) {
      return _then(_value.copyWith(generalComment: value) as $Val);
    });
  }
}
...
class _$_LifeHabitQuestionAnswerResultListModel
  ...
  @override
  @JsonKey(name: 'general_comments')
  final GeneralCommentModel generalComment;

  @override
  String toString() {
    return 'LifeHabitQuestionAnswerResultListModel(list: $list, generalComment: $generalComment)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.generalComment, generalComment) ||
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_list), generalComment);
...
abstract class _LifeHabitQuestionAnswerResultListModel
  ...
  const factory _LifeHabitQuestionAnswerResultListModel(
          {@JsonKey(name: 'results')
              required final List<QuestionAnswerResultModel> list,
          @JsonKey(name: 'general_comments')
              required final GeneralCommentModel generalComment}) =
      _$_LifeHabitQuestionAnswerResultListModel;
  ...
  @override
  @JsonKey(name: 'general_comments')
  GeneralCommentModel get generalComment;
  @override
  @JsonKey(ignore: true)
  _$$_LifeHabitQuestionAnswerResultListModelCopyWith<
          _$_LifeHabitQuestionAnswerResultListModel>
...
GeneralCommentModel _$GeneralCommentModelFromJson(Map<String, dynamic> json) {
  return _GeneralCommentModel.fromJson(json);
}

/// @nodoc
mixin _$GeneralCommentModel {
  ...
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $GeneralCommentModelCopyWith<GeneralCommentModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GeneralCommentModelCopyWith<$Res> {
  factory $GeneralCommentModelCopyWith(
          GeneralCommentModel value, $Res Function(GeneralCommentModel) then) =
      _$GeneralCommentModelCopyWithImpl<$Res, GeneralCommentModel>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GeneralCommentModelCopyWithImpl<$Res, $Val extends GeneralCommentModel>
    implements $GeneralCommentModelCopyWith<$Res> {
  _$GeneralCommentModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_GeneralCommentModelCopyWith<$Res>
    implements $GeneralCommentModelCopyWith<$Res> {
  factory _$$_GeneralCommentModelCopyWith(_$_GeneralCommentModel value,
          $Res Function(_$_GeneralCommentModel) then) =
      __$$_GeneralCommentModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'perfect_comment') String perfectComment,
...
/// @nodoc
class __$$_GeneralCommentModelCopyWithImpl<$Res>
    extends _$GeneralCommentModelCopyWithImpl<$Res, _$_GeneralCommentModel>
    implements _$$_GeneralCommentModelCopyWith<$Res> {
  __$$_GeneralCommentModelCopyWithImpl(_$_GeneralCommentModel _value,
      $Res Function(_$_GeneralCommentModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_GeneralCommentModel(
      perfectComment: null == perfectComment
          ? _value.perfectComment
          : perfectComment // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_GeneralCommentModel implements _GeneralCommentModel {
  const _$_GeneralCommentModel(
      {@JsonKey(name: 'perfect_comment')
  ...
  factory _$_GeneralCommentModel.fromJson(Map<String, dynamic> json) =>
      _$$_GeneralCommentModelFromJson(json);
  ...
  @override
  String toString() {
    return 'GeneralCommentModel(perfectComment: $perfectComment, categoryList: $categoryList)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_GeneralCommentModel &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_GeneralCommentModelCopyWith<_$_GeneralCommentModel> get copyWith =>
      __$$_GeneralCommentModelCopyWithImpl<_$_GeneralCommentModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GeneralCommentModelToJson(
      this,
    );
  }
}

abstract class _GeneralCommentModel implements GeneralCommentModel {
  const factory _GeneralCommentModel(
          {@JsonKey(name: 'perfect_comment')
  ...
  factory _GeneralCommentModel.fromJson(Map<String, dynamic> json) =
      _$_GeneralCommentModel.fromJson;
