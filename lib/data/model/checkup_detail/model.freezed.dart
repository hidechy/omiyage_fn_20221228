...
class _$_CheckupDetailModel implements _CheckupDetailModel {
  ...
  @override
  String toString() {
    return 'CheckupDetailModel(checkupId: $checkupId, childId: $childId, checkupDay: $checkupDay, gestationalWeek: $gestationalWeek, gestationalWeekDay: $gestationalWeekDay, weight: $weight, isNormal: $isNormal, isTa: $isTa, isPih: $isPih, isGdm: $isGdm, isAnemia: $isAnemia, isOtherDisease: $isOtherDisease, note: $note)';
  }
