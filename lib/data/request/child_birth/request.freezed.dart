...
// nullなら新規登録
  ...
  List<ChildBirthDataItem> get childBirthData =>
      throw _privateConstructorUsedError; // 妊娠週数
  @JsonKey(name: 'gestation_period')
  String? get gestationPeriod => throw _privateConstructorUsedError; // 出産場所
...
abstract class $ChildBirthRequestCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'gestation_period') String? gestationPeriod,
...
class _$ChildBirthRequestCopyWithImpl<$Res, $Val extends ChildBirthRequest>
  ...
  $Res call({
    ...
    Object? gestationPeriod = freezed,
    ...
    return _then(_value.copyWith(
      ...
      gestationPeriod: freezed == gestationPeriod
...
// フリーコメント
  ...
  @override
  String toString() {
    return 'ChildBirthRequest(childId: $childId, childBirthData: $childBirthData, gestationPeriod: $gestationPeriod, birthPlace: $birthPlace, birthDoctor: $birthDoctor, motherFatherFeeling: $motherFatherFeeling, message: $message, comment: $comment)';
  }
