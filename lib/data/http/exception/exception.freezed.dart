...
class _$MaintenanceModeHttpStatusException
  ...
  const _$MaintenanceModeHttpStatusException({required this.msg}) : super._();
...
abstract class MaintenanceModeHttpStatusException extends HttpStatusException {
  const factory MaintenanceModeHttpStatusException(
      {required final String msg}) = _$MaintenanceModeHttpStatusException;
...
class _$OtherHttpStatusException extends OtherHttpStatusException {
  const _$OtherHttpStatusException({required this.msg}) : super._();
...
abstract class OtherHttpStatusException extends HttpStatusException {
  const factory OtherHttpStatusException({required final String msg}) =
