...
mixin _$AppConfigState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Map<String, dynamic> config) loaded,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function()? init,
    TResult? Function(Map<String, dynamic> config)? loaded,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$AppConfigStateLoaded implements AppConfigStateLoaded {
  const _$AppConfigStateLoaded({required final Map<String, dynamic> config})
      : _config = config;
...
abstract class AppConfigStateLoaded implements AppConfigState {
  const factory AppConfigStateLoaded(
      {required final Map<String, dynamic> config}) = _$AppConfigStateLoaded;
